...
class SummaryTableCounter {
  ...
  public SummaryTableCounter(AListModel<STFilter> columnModel, AListModel<STFilter> rowModel,
    AListModel<STFilter> counterModel)
  {
  ...
  @ThreadAWT
  public void attach(Lifespan lifespan, @NotNull GenericNode node) {
    if (!node.isNode())
      return;
    ...
    Database.require().addListener(lifespan, new DBListener() {
