...
public class ItemsCollection implements ItemModelRegistryImpl.Listener {
  ...
  public ItemsCollection(ItemModelRegistryImpl editRegistry) {
    ...
    initTimeTracking(editRegistry);
  }

  private void initTimeTracking(ItemModelRegistryImpl editRegistery) {
    final TimeTracker timeTracker = editRegistery.getTimeTracker();
  ...
  public void addItem(final long item, final DBReader reader) {
    final LoadedItemImpl loadedItem = myItems.putNew(item, new Computable<LoadedItemImpl>() {
  ...
  public ItemsCollection createCopy() {
    final ItemsCollection copy = new ItemsCollection(myRegistry);
