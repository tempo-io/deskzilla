...
public class ConnectionLoadingNodeImpl extends GenericNodeImpl implements ConnectionLoadingNode {
  ...
  public ConnectionLoadingNodeImpl(Configuration parentConfig, Connection connection) {
    super(new MyPresentation(getName(connection)), parentConfig.getOrCreateSubset(ConfigNames.CONNECTION_LOADING_KEY));
