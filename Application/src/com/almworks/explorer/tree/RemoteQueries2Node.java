...
public class RemoteQueries2Node extends GenericNodeImpl {
  ...
  public RemoteQueries2Node(ScalarModel<Collection<RemoteQuery2>> remoteQueriesModel, Configuration config) {
    super(FixedText.folder(NAME, NODE_SYSTEM_FOLDER_OPEN, NODE_SYSTEM_FOLDER_CLOSED), config);
