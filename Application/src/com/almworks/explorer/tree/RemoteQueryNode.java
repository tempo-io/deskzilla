...
class RemoteQueryNode extends GenericNodeImpl {
  ...
  public RemoteQueryNode(String connectionNodeId, RemoteQuery remoteQuery) {
    super(new FixedText(remoteQuery.getQueryName(), Icons.NODE_REMOTE_QUERY), Configuration.EMPTY_CONFIGURATION);
