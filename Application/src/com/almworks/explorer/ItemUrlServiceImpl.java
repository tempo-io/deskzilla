...
import com.almworks.api.application.util.sources.*;
...
public class ItemUrlServiceImpl implements ItemUrlService, Startable {
    ...
    throws CantPerformExceptionExplained
  {
    ...
    if (connection != null) {
      ...
      if (confirmationHandler == null) {
        confirmationHandler = ConfirmationHandler.ALWAYS_AGREE;
      }
      confirmationHandler.confirmCreateConnection(provider, configuration, new Procedure<Boolean>() {
    ...
    throws CantPerformExceptionExplained
  {
    ...
    if (source != null) {
      ...
      myExplorerComponent.showItemsInTab(
        source, ItemCollectionContext.createNoNode(title, url, key), false);
   ...
   * */
  @NotNull
  public static ItemSource getItemSourceForUrls(final List<String> urls, final ConnectionManager connMan,
    Function<Integer, Boolean> confirmConnectionsCreation, boolean stopOnFirstFailedConnection, final Procedure<List<String>> onUrlsCannotBeLoaded
  ...
  private static MultiMap<Connection, String> mapUrlsToExistingConnections(List<String> urls, ConnectionManager connMan) {
  ...
  public static class SearchBuilderImpl implements SearchBuilder {
    private final Engine myEngine;
      ...
      try {
        ...
        return getItemSourceForUrls(myUrls, connMan, new Function<Integer, Boolean>() {
          ...
          public Boolean invoke(Integer nConnectionsToCreate) {
            ...
            String msg = myUrls.size() == 1 ? Local.parse(
  ...
  private class OpenInBrowserAction extends SimpleAction {
    ...
    protected void customUpdate(UpdateContext context) throws CantPerformException {
      ...
      try {
        ...
        boolean deleted = wrapper.services().isDeleted();
        if (deleted) {
    ...
    protected void doPerform(ActionContext context) throws CantPerformException {
      ...
      browser.setDialogHandler(L.dialog("Open in Browser"),
