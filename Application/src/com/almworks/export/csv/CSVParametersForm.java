...
public class CSVParametersForm extends FileExporterUIHelper {
  ...
  public CSVParametersForm(Configuration config) {
    ...
    UIUtil.configureEncodingCombo(myLife, myEncoding, encodingConfig.getOrCreateSubset("value"), null,
      encodingConfig.getOrCreateSubset("recents"), CSVExporter.getDefaultCharset());
  }
