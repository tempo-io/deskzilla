...
import com.almworks.actions.create.CreateItemHelper;
import com.almworks.actions.create.NewArtifactForm;
import com.almworks.actions.distribution.CreateDistribution;
import com.almworks.actions.merge2.MergePrimaryItemAction;
import com.almworks.actions.order.ReorderTableAction;
import com.almworks.api.actions.DeleteAttachmentAction;
...
public class ExplorerActions implements Startable {
  ...
  private final ProductDistributionType myDistributionType;
  private final Engine myEngine;

  public ExplorerActions(ActionRegistry registry, ProductInformation productInformation, Engine engine) {
    myRegistry = registry;
    myDistributionType = productInformation.getDistributionType();
    myEngine = engine;
  }

  public void start() {
    myRegistry.registerAction(MainMenu.Edit.EDIT_ITEM, new EditPrimaryItemAction());
    ...
    myRegistry.registerAction(MainMenu.Edit.DELETE_ATTACHMENT, new DeleteAttachmentAction());
    ...
    myRegistry.registerAction(MainMenu.File.SHOW_CONNECTION_INFO, new ShowConnectionInfo());
...
//    myRegistry.registerAction(MainMenu.Edit.DOWNLOAD_DETAILS, new DownloadDetailsAction());
    ...
    myRegistry.registerAction(MainMenu.Tools.REORDER_TABLE, ReorderTableAction.INSTANCE);
    ...
    StdItemActions.registerActions(myRegistry);
  ...
  static <T extends GenericNode> T getSingleNavigationNode(ActionContext context, DataRole<T> role)
        ...
        public void invoke(QueryUrlInfo info) {
          ...
          if (!info.isValid()) {
            ...
            if (urls != null && urls.size() > 0) {
              ...
              if (!proceed) {
                int r = JOptionPane.showConfirmDialog(null, warning, "Confirm Open Query in Browser",
