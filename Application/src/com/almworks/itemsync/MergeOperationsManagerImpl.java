...
public class MergeOperationsManagerImpl implements MergeOperationsManager {
  ...
  private static class MyBuilder implements Builder {
    ...
    @Override
    public void addCustom(final ItemAutoMerge merge) {
      myMerges.add(merge);
    }
    ...
    @Override
    public void addConflictGroup(DBAttribute<?>... attrGroup) {
