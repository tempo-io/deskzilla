...
public interface TimeTrackingCustomizer {
   ...
   * @param a The artifact wrapper.
   * @return The remainig time estimate or {@code null} if it is
   * not set or unavailable.
   */
  @Nullable Integer getRemainingTime(@NotNull ItemWrapper a);
   ...
   * not set or unavailable.
   */
  @Nullable Integer getTimeSpent(@NotNull ItemWrapper a);
   ...
   */
  @Nullable Integer getTimeSpentByMe(ItemWrapper a);
   ...
   * @return An EditCommit that publishes TT data.
   */
  @Nullable
  EditCommit createPublishingCommit(
