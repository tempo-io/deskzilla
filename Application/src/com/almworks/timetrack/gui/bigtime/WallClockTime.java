...
public class WallClockTime extends BigTimeImpl {
  ...
  public void getBigTimeText(Procedure<String> proc) {
    final TimeTracker tracker = Context.require(TimeTracker.class);
    final boolean trackingActive = tracker.isTracking();
    ...
    if(trackingActive) {
      ...
      final Pair<TimeTrackerTask,TaskTiming> preceding = tracker.getPrecedingTiming(now);
      if(preceding == null) {
