...
public class TimeTrackerWindowComponent implements Startable {
  ...
  public TimeTrackerWindowComponent(ActionRegistry actionRegistry, TimeTrackerSettings settings,
    TimeTracker timeTracker, TrayIconService trayIconService, ProductInformation productInfo)
  {
  ...
  public void start() {
    ...
    ThreadGate.AWT.execute(new Runnable() {
      public void run() {
        myTimeTracker.getModifiable().addAWTChangeListener(new ChangeListener() {
