...
public class EventRouterTests extends BaseTestCase {
  ...
  public void testOneOrder() {
    ...
    Detach summerDetach = myRouter.addListener(ThreadGate.STRAIGHT, summer);
    Detach multiplierDetach = myRouter.addListener(ThreadGate.STRAIGHT, multiplier);
  ...
  public void testFromParentToChild() {
    ...
    Listener sink = myRouter.getEventSink(Listener.class, false);
    Detach summerDetach = child.addListener(ThreadGate.STRAIGHT, summer);
    Detach multiplierDetach = myRouter.addListener(ThreadGate.STRAIGHT, multiplier);
  ...
  public void testFromChildToParentNO() {
    ...
    child.addListener(ThreadGate.STRAIGHT, summer);
    myRouter.addListener(ThreadGate.STRAIGHT, multiplier);
