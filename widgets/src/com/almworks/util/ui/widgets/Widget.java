 ...
 * Widget handles lifecycle and stores state in cell.<br>
 * <strong>Life cycle</strong><br>
 * Each widget can be attached to zero or more hosts. Host controls "static lifecycle" - time when widget can be used by host.
 * Static lifecycle<br>
 ...
 * hosts it may (or may not) be attached to one another again in future.
 * Cell lifecycle<br>
