...
public class TagInfoConvertor extends Convertor<ArtifactDb.TagInfo, TagFileStorage.TagInfo> {
  ...
  @Override
  public TagFileStorage.TagInfo convert(ArtifactDb.TagInfo tagInfo) {
