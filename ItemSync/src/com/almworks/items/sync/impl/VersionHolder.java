  ...
  static class WriteShadow extends Write {
    ...
    public <T> boolean setValue(DBAttribute<T> attribute, T value) {
      if (myValues != null) {
        ...
        if (current != null && ItemDiffImpl.isEqualValue(getReader(), attribute, current, value)) return false;
      }
    ...
    protected <T> boolean setShadowableValue(DBAttribute<T> attribute, T value) {
      if (myValues == null) {
        ...
        if (ItemDiffImpl.isEqualValue(getReader(), attribute, value, current)) return false;
