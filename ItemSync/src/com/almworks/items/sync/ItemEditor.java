...
public interface ItemEditor {
   ...
   * Edit can not be committed before entering state EDIT since edit subsystem is not sure if editor is ready.<br>
   ...
   * @throws com.almworks.util.ui.actions.CantPerformException if edit can not be activated.<br>
