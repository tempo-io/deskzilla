...
public class TextUtil {
  ...
  public static String concatenate(Collection<? extends String> strings) {
    return separate(strings, "");
  }

  public static <T> String separate(T[] strings, String separator, Convertor<T, String> convertor) {
    return separate(Arrays.asList(strings), separator, convertor);
  }

  public static String separate(Collection<? extends String> strings, String separator) {
    return separate(strings, separator, Convertors.<String>identity());
  }

  public static <T> String separate(Collection<? extends T> strings, String separator, Convertor<T, String> convertor) {
  ...
  public static <T> String separate(Iterator<? extends T> it, String separator, Convertor<T, String> convertor) {
    ...
    while (it.hasNext()) {
      T element = it.next();
      String string = convertor.convert(element);
  ...
  public static String separateToString(List<?> list, String separator) {
  ...
  public static String separeteTimes(String input, String separator, int times) {
