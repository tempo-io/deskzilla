...
public class Containers {
  ...
  public static <E, V> Comparator<E> convertingComparator(
    final Convertor<E, V> convertor, Comparator<? super V> comparator)
  {
    return new ConvertingComparator<E, V>(comparator, new ReadAccessor<E, V>() {
      @Override
  ...
  public static <E, V extends Comparable<V>> Comparator<E> convertingComparator(final Convertor<E, V> convertor) {
  ...
  public static <T> Collection<T> intersect(Collection<? extends T> set1, Collection<? extends T> set2) {
    if (set1.isEmpty() || set2.isEmpty())
      return Collections15.emptySet();
    Collection<T> result = Collections15.hashSet();
    for (T item : set1)
   ...
   */
  @NotNull
  public static <T> Collection<T> complement(Collection<? extends T> a, Collection<? extends T> b) {
  ...
  public static <T extends Comparable> Comparator<List<T>> lexicographicComparator() {
    return new Comparator<List<T>>() {
      public int compare(List<T> list1, List<T> list2) {
        int size1 = list1.size();
        int size2 = list2.size();
        if (size1 != size2)
          return Containers.compareInts(size1, size2);
  ...
  public static <T extends Comparable> Comparator<List<T>> lexicographicComparator(boolean nullsFirst) {
    Comparator<List<T>> comparator = lexicographicComparator();
    return nullableComparator(comparator, nullsFirst);
  }
  ...
  public static <A, R> Function<A, R> constFunction(final R value) {
  ...
  /**
   * @return a pair of added items and removed items
   */
  public static <T> Pair<Collection<T>, Collection<T>> diffSet(Collection<T> from, Collection<T> to) {
   ...
   */
  public static <T extends Comparable<? extends T>> List<T> toUniqueSortedList(List<T> list) {
