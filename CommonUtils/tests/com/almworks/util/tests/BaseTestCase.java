...
public abstract class BaseTestCase extends TestCase {
  ...
  public final void setGate(ThreadGate threadGate) {
    ...
    assert threadGate != ThreadGate.AWT : "ThreadGate.AWT_IMMEDIATE should be used";
  ...
  private void finish(boolean loggedFailure) throws Throwable {
    ...
    assertTrue("timeout " + myTestTimeout + "ms", !myTimeout);
  }
  ...
  protected static interface RunnableE<E extends Throwable> {
