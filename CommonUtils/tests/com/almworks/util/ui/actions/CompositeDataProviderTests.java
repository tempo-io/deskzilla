...
public class CompositeDataProviderTests extends GUITestCase {
  ...
  public void testDataAndComponent() {
    ...
    assertNull(composite.getSourceComponent(ROLE));
    ...
    assertSame(component, composite.getSourceComponent(ROLE));
  }
  ...
  public void testConstProvider() {
    ...
    assertSame(component, DataProvider.DATA_PROVIDER.getClientValue(component).getSourceComponent(ROLE));
  }
}
