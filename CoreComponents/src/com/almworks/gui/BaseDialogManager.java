...
public abstract class BaseDialogManager implements DialogManager {
  ...
  public ShowOnceMessageBuilder createOnceMessageBuilder(String messageId) {
    return new ShowOnceMessageBuilderImpl(createMainBuilder(messageId), getConfiguration(messageId));
  }
