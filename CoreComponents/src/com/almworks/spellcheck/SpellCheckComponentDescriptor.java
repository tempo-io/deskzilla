...
public class SpellCheckComponentDescriptor implements ComponentDescriptor {
  ...
  public void registerActors(RootContainer container) {
    ...
    RegisterActions.registerAction(container, MainMenu.Tools.SPELL_CHECKER_SETTINGS, new SimpleAction(
      SpellCheckManager.I18N.getFactory("spellcheck.actions.settings.name"), null) {
      @Override
      ...
      protected void doPerform(ActionContext context) throws CantPerformException {
        SpellCheckSettings.showDialog(context.getSourceObject(DialogManager.ROLE), context.getSourceObject(
          SpellCheckManager.ROLE).getConfig());
      }
    });
  }
}
