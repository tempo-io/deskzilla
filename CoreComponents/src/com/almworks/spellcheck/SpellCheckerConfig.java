...
import com.almworks.spellcheck.dictionary.*;
...
class SpellCheckerConfig {
   ...
   */
  private static final DicInfo JARGON_DICTIONARY = new DicInfo("-jargon-", null, "Bugzilla Jargon", "");
  private static final DicInfo DEFAULT_DICTIONARY = new DicInfo("english.jar", "english", "English", "en");
  public static final List<DicInfo> DICTIONARIES = Collections15.unmodifiableListCopy(JARGON_DICTIONARY,
    DEFAULT_DICTIONARY, new DicInfo("russian.jar", "russian", "Русский", "ru"),
//    new DicInfo("cz.jar", "cz", "Čeština", "cs"),
    new DicInfo("de.jar", "de", "Deutsch", "de"), new DicInfo("es.jar", "es", "Español", "es"),
