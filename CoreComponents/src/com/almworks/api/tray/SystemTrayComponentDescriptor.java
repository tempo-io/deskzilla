...
public class SystemTrayComponentDescriptor implements Startable, TrayIconService {
  ...
  public SystemTrayComponentDescriptor(ActionRegistry registry, Configuration configuration,
    MainWindowManager windowManager, ApplicationManager applicationManager, ProductInformation productInfo)
  {
    myRegistry = registry;
    myApplicationManager = applicationManager;
    myView = new SystemTrayApplicationView(configuration, windowManager, productInfo);
  }
