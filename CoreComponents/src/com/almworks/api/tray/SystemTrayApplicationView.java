...
public class SystemTrayApplicationView {
  ...
  public SystemTrayApplicationView(
    Configuration config, MainWindowManager windowManager, ProductInformation productInfo)
  {
    myConfig = config;
...
//      cls_TrayIcon.getMethod("setImageAutoSize", boolean.class).invoke(icon, true);
  ...
  private Image createTrayImage() {
    ...
    image = ImageUtil.createBufferedImage(image, Transparency.BITMASK);
    return image;
  }
