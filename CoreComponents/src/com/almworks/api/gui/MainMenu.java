...
public interface MainMenu {
  String X_NEW_SUBTASK = "X.New.Subtask";
  String X_PUBLISH_TIME = "X.Publish.Time";
  String X_LOG_WORK = "X.Log.Work";
  ...
  interface Edit {
    ...
    String NEW_SUBTASK = "Edit.NewSubtask";
...
//    String VIEW_NOTE = "Tools.ViewNote";
  ...
  interface ItemEditor {
    String COMMIT = "ArtifactEditor.Commit";
    String SAVE_DRAFT = "ArtifactEditor.SaveDraft";
    String DISCARD = "ArtifactEditor.Discard";
  }
  ...
  interface Attachments {
    ...
    String VIEW = "Attachments.DownloadAndView";
