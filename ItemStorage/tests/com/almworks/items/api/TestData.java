...
public abstract class TestData {
  ...
  public static final DBAttribute<Long> LINK = DBAttribute.Link("link", "Link", true);
  ...
  public static final DBAttribute<byte[]> ARRAY = DBAttribute.Scalar("array", "Bytes", byte[].class);
  public static final DBAttribute<Character> CHAR = DBAttribute.Scalar("char", "Character", Character.class);
  public static final DBAttribute<AttributeMap> MAP =
    DBAttribute.Scalar("attributeMap", "Attribute Map", AttributeMap.class);
