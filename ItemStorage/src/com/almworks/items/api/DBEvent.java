...
public class DBEvent {
  ...
  private boolean checkInvariants(LongList changed, LongList added, LongList removed, LongList affected) {
    assert changed.isUniqueSorted() : changed;
    assert added.isUniqueSorted() : added;
    assert removed.isUniqueSorted() : removed;
    assert affected.isUniqueSorted() : affected;
    ...
    checkIncludes(builder.toSortedCollection(), affected, false);
    return true;
  }
  ...
  private static LongList buildAffected(LongList v1, LongList v2, LongList v3) {
    ...
    return builder.toSortedCollection();
  }
  ...
  public LongList getAddedAndChangedSorted() {
    ...
    if (r == null) {
      ...
      myAddedAndChangedSorted = r = builder.toSortedCollection();
    }
    return r;
  }
  ...
  public LongList getRemovedAndChangedSorted() {
    ...
    if (r == null) {
      ...
      myRemovedAndChangedSorted = r = builder.toSortedCollection();
    }
    return r;
  }
