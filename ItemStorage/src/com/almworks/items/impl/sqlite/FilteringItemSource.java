...
//      processor.attach(life, this);
    ...
    throws SQLiteException
  {
    ...
    LongList additional = additionalBuilder.isEmpty() ? null : additionalBuilder.toSortedCollection();
...
*/
    ...
    ExtractionProcessor processor) throws SQLiteException
  {
    ...
    try {
      ...
      while (affectingIndexes.hasNext()) {
        ...
        sortedFutureIds = futureBuilder.toSortedCollection();
    ...
    long[] buffer) throws SQLiteException
  {
    ...
    assert currentIds == null || currentIds.isUniqueSorted();
    ...
    public LongIterator iterator() {
      return new LongIterator() {
        ...
        public long next() throws ConcurrentModificationException, NoSuchElementException {
          return myIds.get(myIndexes[myNext++]);
        }
      };
    }
  }
