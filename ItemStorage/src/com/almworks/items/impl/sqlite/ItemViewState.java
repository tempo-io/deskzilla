...
import com.almworks.integers.util.DiffIndexedLongListDecorator;
...
public class ItemViewState {
   ...
   */
  @Nullable
  private final DiffIndexedLongListDecorator myItemsTree;
  ...
  public ItemViewState(LongList itemList, LongList itemGraph, DiffIndexedLongListDecorator itemTree, IntList depths, AbstractGroupsDist groups) {
  ...
  @Nullable
  public DiffIndexedLongListDecorator getItemsTree() {
    return myItemsTree;
  }
