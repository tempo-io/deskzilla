...
public class DBStatusKeyTests extends MemoryDatabaseFixture {
  final static DBAttribute<Long> SLAVE_1 = DBAttribute.Long("slave1", "Slave 1");
  final static DBAttribute<Long> SLAVE_2 = DBAttribute.Long("slave2", "Slave 2");
  final static DBAttribute<String> TEXT = DBAttribute.String("textAttr", "Text attr");

  static {
    SyncSchema.markShadowable(TEXT);
    SLAVE_1.initialize(DBAttribute.PROPAGATING_CHANGE, true);
    SLAVE_2.initialize(DBAttribute.PROPAGATING_CHANGE, true);
  }
