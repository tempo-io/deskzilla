...
public class StdRules {
  ...
  private static ConstraintTreeElement equalsOr(TypedKey<FieldIntConstraint> type, @NotNull FieldIntConstraint intConstraint) {
    ...
    DBAttribute attibute = intConstraint.getAttribute();
    BigDecimal value = intConstraint.getIntValue();
    node.addChild(new ConstraintTreeLeaf(FieldIntConstraint.Simple.equals(attibute, value)));
    node.addChild(new ConstraintTreeLeaf(new FieldIntConstraint.Simple(type, attibute, value)));
    return node;
  }
