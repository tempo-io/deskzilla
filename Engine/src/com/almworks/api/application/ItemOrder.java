...
public final class ItemOrder implements Comparable<ItemOrder> {
  public static final ItemOrder NO_ORDER = new ItemOrder(null, null, null);
  ...
  private ItemOrder(Long numeric0, long[] numerics, String string) {
    myNumeric0 = numeric0;
    myNumerics = numerics;
    myString = string;
  }
  ...
  public static ItemOrder byString(String string) {
    return new ItemOrder(null, null, string == null ? string : string.intern());
  }

  @NotNull
  public static ItemOrder byOrderAndString(long value, String string) {
    return new ItemOrder(value, null, string == null ? string : string.intern());
  }

  @NotNull
  public static ItemOrder byOrder(long value) {
    return new ItemOrder(value, null, null);
  }
  ...
  public static ItemOrder adjustString(@Nullable ItemOrder order, @Nullable String string) {
    if (order == null) {
      ...
      if (Util.equals(order.getString(), string)) {
        ...
        return new ItemOrder(order.myNumeric0, order.myNumerics, string);
      }
    }
  }

  public static ItemOrder byGroup(String string, long[] values) {
    return new ItemOrder(null, values, string);
  }

  public static ItemOrder byNumbers(long ... values) {
    return new ItemOrder(null, values, null);
  }
