...
public interface GenericNode extends IdentifiableNode, Comparable<GenericNode> {
  ...
  @Nullable(documentation = "when there's no valid contstraint or when precise hypercube is requested and is not available")
  ItemHypercube getHypercube(boolean precise);

//  Modifiable getHypercubeModifiable();
  ...
  void acceptItems(List<ItemWrapper> wrappers, DragContext context) throws CantPerformException;

  boolean canAcceptItems(List<ItemWrapper> wrappers, DragContext context) throws CantPerformException;
