...
public class DistributionParameters {
  ...
  public static DistributionParameters readConfig(Configuration config) {
    ...
    StringFilterSet valuesFilter =
      StringFilterSet.readFrom(config.getOrCreateSubset(ConfigNames.DISTRIBUTION_VALUES_FILTER));
    StringFilterSet groupsFilter =
      StringFilterSet.readFrom(config.getOrCreateSubset(ConfigNames.DISTRIBUTION_GROUPS_FILTER));
