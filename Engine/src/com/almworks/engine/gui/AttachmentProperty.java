...
public abstract class AttachmentProperty<T extends Attachment, V> implements Comparator<V> {
  ...
  public static final AttachmentProperty<Attachment, Integer> ORDER = new OrderProperty();
  ...
  private static class OrderProperty extends AttachmentProperty<Attachment, Integer> {
    ...
    public Integer getColumnValue(@NotNull Attachment attachment, @Nullable DownloadedFile downloadedFile) {
      return attachment.getNumber();
    }

    public String getStringValue(@NotNull Attachment attachment, DownloadedFile downloadedFile) {
      return String.valueOf(attachment.getNumber());
    }
  }
  ...
  private static class FileNameProperty extends AttachmentProperty<Attachment, String> {
    ...
    public String getColumnValue(Attachment attachment, DownloadedFile downloadedFile) {
      ...
      if (downloadedFile != null) {
        if (fileName == null || downloadedFile.getState() == READY) {
