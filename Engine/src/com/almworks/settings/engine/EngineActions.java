...
public class EngineActions implements Startable {
  ...
  private void registerInternalActions() {
    ...
    myRegistry.registerAction(MainMenu.Tools.EXCEPTION, new AnAbstractAction(L.actionName("Throw Exception")) {
      public void perform(ActionContext context) throws CantPerformException {
        throw new Failure("Your Exception, Sir.");
      }
    });

    myRegistry.registerAction(MainMenu.Tools.LOG_ERROR, new AnAbstractAction(L.actionName("Log Error")) {
      public void perform(ActionContext context) throws CantPerformException {
    ...
    myRegistry.registerAction(MainMenu.Tools.DUMP_DB, new EnabledAction("Dump Database") {
      ...
      protected void doPerform(ActionContext context) throws CantPerformException {
        ...
        Database.require().dump(new File(wa.getRootDir(), "dump.txt").getPath());
