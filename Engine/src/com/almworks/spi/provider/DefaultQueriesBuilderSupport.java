...
public abstract class DefaultQueriesBuilderSupport {
  ...
  protected static Element createQuery(Element parent, String queryName, String queryFormula) {
  ...
  protected static Element createFolder(Element parent, String name) {
