 ...
 * can be guarantied in this case since accessing thread can not be sure about current model state.
      ...
      for (int i = 0; i < myModel.getSize(); i++) {
        ...
        if (element != null) {
          ...
          if (key != null) {
            ...
            if (expunged != null) {
              assert false : key + " " + element + " " + expunged;
              Log.warn("LMMC: " + key + " " + element + " " + expunged);
            }
          }
        }
      }
