...
public class SelectionInListModel <T> extends DelegatingAListModel<T> implements AComboboxModel<T> {
  ...
  private AListModel<T> myData = AListModel.EMPTY;
  ...
  private void attachData(AListModel<T> data) {
    myData = data;
  ...
  @NotNull
  public static <T> SelectionInListModel<T> create(@NotNull Lifespan lifespan, @NotNull AListModel<T> list, @Nullable T initialSelection) {
