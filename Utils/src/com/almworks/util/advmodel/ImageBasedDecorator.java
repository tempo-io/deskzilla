...
//    resynch();
  ...
  public Detach addListener(final AListModel.Listener<D> listener) {
  ...
  public static class ComplemetaryListModel<T> extends ImageBasedDecorator<T, T> {
    ...
    public ComplemetaryListModel(AListModel<T> fullSet, AListModel<T> subsetModel) {
      super(fullSet);
    ...
    public AListModel<? extends T> getSubsetModel() {
      return mySubset;
    }
  }
}
