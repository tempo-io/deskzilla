 ...
 * 1. Force update of all {@link com.almworks.util.ui.AActionComponent action components}<br>
...
public class LocalizedUIUpdate implements ChangeListener {
   ...
   */
  public static final ComponentProperty<Procedure<JComponent>>
    UPDATE_LOCALE = ComponentProperty.createProperty("updateLocale");
