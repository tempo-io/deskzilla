...
public class StringDragImageFactory implements Factory<Image> {
  ...
  public StringDragImageFactory(String string, Component component, Color background) {
    myString = string;
  ...
  public Image create() {
    ...
    try {
      Color bg = myBackground != null ? myBackground : UIManager.getColor("List.selectionBackground");
  ...
  public static void ensureContext(DragContext context, TypedKey<Factory<Image>> key, String string,
    Component component, Color background)
  {
    ...
    if (f instanceof StringDragImageFactory) {
      ...
      if (Util.equals(factory.myBackground, background) && Util.equals(factory.myString, string) &&
        Util.equals(factory.myComponent, component))
      {
        return;
      }
    }
    context.putValue(key, new StringDragImageFactory(string, component, background));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (myBackground != null ? !myBackground.equals(factory.myBackground) : factory.myBackground != null)
      return false;
