...
public class RowIcon implements Icon {
  ...
  private final int myLeftMargine;
  private final int myRightMargine;

  private RowIcon(Icon[] icons, int defaultWidth, int defaultHeight, int gap, int leftMargine, int rightMargine) {
    assert checkIcons(icons);
    myLeftMargine = leftMargine;
    myRightMargine = rightMargine;
    myIcons = icons;
    myGap = gap;
    myHeight = getHeight(icons, defaultHeight);
    myDefaultWidth = defaultWidth;
    myWidth = getWidth(icons, myDefaultWidth, gap, leftMargine, rightMargine);
  }
  ...
  public static RowIcon create(int defaultWidth, int defaultHeight, int gap, int leftMargine, int rightMargine, Icon ... icons) {
    return new RowIcon(icons, defaultWidth, defaultHeight, gap, leftMargine, rightMargine);
  }
