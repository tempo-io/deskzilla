...
public class TreeBuilder<E, N extends TreeModelBridge<? extends E>> {
  ...
  private Set<Object> getParentKeys(E element) {
    if(myTreeStructure instanceof TreeStructure.MultiParent) {
      return ((TreeStructure.MultiParent)myTreeStructure).getNodeParentKeys(element);
    }
    final Object key = myTreeStructure.getNodeParentKey(element);
