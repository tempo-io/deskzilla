...
public class ListModelTreeAdapter <T, N extends TreeModelBridge<T>> {
  ...
  public static <T> ListModelTreeAdapter<T, TreeModelBridge<T>> createFlat(AListModel<? extends T> list) {
    return new ListModelTreeAdapter<T, TreeModelBridge<T>>(list, new TreeStructure.FlatTree<T>(), null, null);
  }
