...
public class CompletingComboBoxController<T> {
  ...
  private final RecentController myRecents;
  ...
  CompletingComboBoxController(CompletingComboBox<T> comboBox) {
    ...
    myRecents = new RecentController(myFiltered, true);
...
//    myComboBox.setRenderer(new AComboBox.RendererAdapter<T>(Renderers.createRenderer(myBoldingRenderer), myComboBox));
  ...
  @Deprecated
  public void setConvertors(Convertor<? super T, String> toString, Convertor<String, T> fromString) {
    //noinspection unchecked
    setConvertors(toString, fromString, Equality.GENERAL);
  }
  ...
  @Nullable
  protected NotifingComboBoxEditor<T> getEditor() {
    //noinspection unchecked
