...
public class StringFilterSetEditor {
  ...
  public StringFilterSet getValue() {
    if (myCachedValue == null)
      myCachedValue = createValue();
    return myCachedValue;
  }

  private StringFilterSet createValue() {
    Kind kind = myKindCombo.getModel().getSelectedItem();
    return new StringFilterSet(Util.NN(kind, Kind.ALL), myFiltersModel.toList());
  }
