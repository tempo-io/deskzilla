...
import com.softcorporation.suggester.*;
...
import com.softcorporation.suggester.util.*;
...
public class MultiDictionarySuggester extends Suggester {
  ...
  @Nullable
  public static Suggester create(BasicSuggesterConfiguration config, Collection<? extends Dictionary> dictionaries) throws
    SuggesterException
  {
