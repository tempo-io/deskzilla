...
public class TextSpellChecker {
  ...
  public static TextSpellChecker install(Lifespan life, JTextComponent component, SpellCheckConfiguration config, Suggester suggester) throws
    SuggesterException
  {
    ...
    if (!life.isEnded()) {
      UIUtil.addTextListener(life, component, checker.myRecheck);
  ...
  private static class MyDocumentListener implements Runnable, ChangeListener {
